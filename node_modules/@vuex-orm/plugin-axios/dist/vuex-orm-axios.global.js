var VuexORMAxios = (function () {
    ...
    ***************************************************************************** */
    ...
    var Response = /** @class */ (function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            method = this.config.persistBy || 'insertOrUpdate';
                            ...
                            options = this.getPersistOptions();
                            _a = this;
                            return [4 /*yield*/, this.model[method](__assign({ data: data }, options))];
                        case 1:
                            _a.entities = _b.sent();
                            this.isSaved = true;
                            return [2 /*return*/];
         ...
         */
        Response.prototype.getPersistOptions = function () {
            var persistOptions = this.config.persistOptions;
         ...
         */
        Response.prototype.validatePersistAction = function (action) {
