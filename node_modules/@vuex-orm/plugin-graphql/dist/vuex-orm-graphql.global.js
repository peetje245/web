var VuexORMGraphQLPlugin = (function (exports) {
    'use strict';
    ...
    ***************************************************************************** */
    ...
    var Logger = /** @class */ (function () {
        ...
        Logger.prototype.group = function () {
            ...
            if (this.enabled) {
                if (console.groupCollapsed) {
                    console.groupCollapsed.apply(console, __spreadArrays(this.PREFIX, messages));
                }
                else {
                    console.log.apply(console, __spreadArrays(this.PREFIX, messages));
                }
            }
        };
        /**
        ...
        Logger.prototype.warn = function () {
            ...
            if (this.enabled) {
                console.warn.apply(console, __spreadArrays(this.PREFIX, messages));
            }
        };
        /**
    ...
    })(exports.ArgumentMode || (exports.ArgumentMode = {}));
    ...
    var Schema = /** @class */ (function () {
        ...
        Schema.prototype.determineQueryMode = function () {
            ...
            if (connection.fields.find(function (f) { return f.name === "nodes"; })) {
                return exports.ConnectionMode.NODES;
            }
    ...
    var DefaultAdapter = /** @class */ (function () {
        ...
        DefaultAdapter.prototype.getArgumentMode = function () {
            return exports.ArgumentMode.TYPE;
        };
    ...
    var Context = /** @class */ (function () {
        ...
        Context.prototype.processSchema = function () {
            ...
            if (this.connectionMode === exports.ConnectionMode.AUTO) {
        ...
        QueryBuilder.prepareArguments = function (args) {
            ...
            Object.keys(args).forEach(function (key) {
                ...
                if (value && isPlainObject(value)) {
                    if (Context.getInstance().adapter.getArgumentMode() === exports.ArgumentMode.LIST) {
