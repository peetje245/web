...
var HasMany = /** @class */ (function (_super) {
    ...
    HasMany.prototype.attach = function (key, record, data) {
        ...
        key.forEach(function (index) {
            ...
            if (!related ||
                !related[index] ||
                related[index][_this.foreignKey] !== undefined) {
                return;
            }
    ...
    BelongsToMany.prototype.createPivotRecord = function (data, record, related) {
        ...
        related.forEach(function (id) {
            ...
            var pivotKey = JSON.stringify([
                _this.pivot.primaryKey[0] === _this.foreignPivotKey
                    ? parentId
                    : relatedId,
                _this.pivot.primaryKey[1] === _this.foreignPivotKey ? parentId : relatedId
            ]);
            var pivotRecord = data[_this.pivot.entity]
                ? data[_this.pivot.entity][pivotKey]
                : {};
...
var MorphMany = /** @class */ (function (_super) {
    ...
    MorphMany.prototype.attach = function (key, record, data) {
        ...
        key.forEach(function (id) {
            ...
            relatedItem[_this.id] =
                relatedItem[_this.id] || _this.related.getIdFromRecord(record);
...
var MorphToMany = /** @class */ (function (_super) {
    ...
    MorphToMany.prototype.createPivots = function (parent, data, key) {
        var _this = this;
        Utils.forOwn(data[parent.entity], function (record) {
            var relatedIds = parent
                .query()
                .newQuery(_this.pivot.entity)
 ...
 */
var query$1 = function (state, _getters, _rootState, rootGetters) { return function () {
    return rootGetters[state.$connection + "/query"](state.$name);
}; };
/**
 * Get all data of given entity.
 */
var all$1 = function (state, _getters, _rootState, rootGetters) { return function () {
    return rootGetters[state.$connection + "/all"](state.$name);
}; };
/**
 * Find a data of the given entity by given id.
 */
var find$1 = function (state, _getters, _rootState, rootGetters) { return function (id) {
    return rootGetters[state.$connection + "/find"](state.$name, id);
}; };
/**
 * Find array of data of the given entity by given ids.
 */
var findIn$1 = function (state, _getters, _rootState, rootGetters) { return function (idList) {
 ...
 * use the `insert` method instead.
 */
function create$1(context, payload) {
    return __awaiter(this, void 0, void 0, function () {
        var state, entity;
        return __generator(this, function (_a) {
            state = context.state;
 ...
 */
function insert$2(context, payload) {
    return __awaiter(this, void 0, void 0, function () {
        var state, entity;
        return __generator(this, function (_a) {
            state = context.state;
 ...
 */
function update$1(context, payload) {
    return __awaiter(this, void 0, void 0, function () {
        var state, entity;
        return __generator(this, function (_a) {
            state = context.state;
 ...
 */
function insertOrUpdate$1(context, payload) {
    return __awaiter(this, void 0, void 0, function () {
        var state, entity;
        return __generator(this, function (_a) {
            state = context.state;
...
function destroy$2(context, payload) {
    return __awaiter(this, void 0, void 0, function () {
...
var Query = /** @class */ (function () {
    ...
    Query.prototype.records = function () {
        ...
        return this.getIdsToLookup().reduce(function (models, id) {
            ...
            if (!_this.appliedOnBase &&
                !(_this.model.entity === model.$self().entity)) {
                return models;
            }
            models.push(model);
            return models;
...
var Database = /** @class */ (function () {
    ...
    Database.prototype.model = function (model) {
        ...
        var m = entity ? entity.model : null;
        if (!m) {
    ...
    Database.prototype.baseModel = function (model) {
        ...
        var m = entity ? this.model(entity.base) : null;
        if (!m) {
            throw new Error("[Vuex ORM] Could not find the model `" + name + "`. Please check if you " +
                'have registered the model to the database.');
        }
