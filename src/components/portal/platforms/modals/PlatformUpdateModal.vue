<template>
   <q-page v-if="platform">
        <q-dialog v-model="confirm" persistent>
            <q-card style="width: 700px; max-width: 80vw;">
                <q-card-section class="row items-center q-pb-none">
                    <div class="text-h6">{{$t('platform.update')}}</div>
                    <q-space></q-space>
...
export default {
    ...
    data(){
        return{
            ...
            release_year: this.platform.release_year,
            active: this.platform.active,
    ...
    methods:{
        ...
        save(){
            ...
            if(!this.titleError && !this.releaseYearError){
                ...
                this.$store.dispatch('platforms/updatePlatform', data);
                this.$emit('close');
            }
        },
