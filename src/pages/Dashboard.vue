<template>
    <q-page>
        <div class="flex flex-center" v-if="!articles.length">
            <q-circular-progress
                indeterminate
                size="50px"
                color="lime"
        ...
        <div v-else class="col-12 row">
            <div class="col-2">
                ...
                <q-list class="q-pa-md bg-grey-10 text-white" dark style="max-width: 318px">
                    ...
                    <q-separator dark></q-separator>
                    <q-item-label header>Platforms</q-item-label>
                    ...
                    <q-separator dark></q-separator>
                    <q-item-label header>Series</q-item-label>
            ...
            <div class="col-9 offset-1">
                ...
                <div class="row">
                    <q-card v-for="article in articles" :key="article.id" class="col-11">
